...
public class PrecoItemCardapio {
	...
	public int codPreco, codItemCardapio, codCardapio, codEstabelecimento, codSabor, codTamanho, qtdSabor;
	public float valPreco;
	public String nomItemCardapio, indAtivo, nomSabor, desTamanho, codLegado, codBarra;
