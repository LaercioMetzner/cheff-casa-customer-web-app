...
import java.util.Date;
	...
	public class Parceiro implements IUser {
	public int codParceiro;
	public String desEmail, desSenha, nomParceiro, numCpfCnpj,
			desEndereco, desComplemento, desBairro, nomCidade,
			indFormaPgto, numBanco, numAgencia, numConta, indAtivo;
