...
public class ItemCardapio {
	...
	public int codItemCardapio, codCardapio, codEstabelecimento, numOrdem;
	public String nomItemCardapio, desItemCardapio, indAtivo, codPhotoIdItem, desSourcePhoto;
