...
(function(){
    ...
    .controller('listOrdensEntradaController', ['$scope', '$http', '$routeParams', '$location', 'ordemEntradaService', 'utilsService', function($scope, $http, $routeParams, $location, ordemEntradaService, utilsService){
