...
(function(){
    ...
    .controller('editOrdemEntradaController', ['$scope', '$http', '$routeParams', '$location', 'ordemEntradaService', '$window', 'utilsService', function($scope, $http, $routeParams, $location, ordemEntradaService, $window, utilsService){
