...
(function(){
    ...
    .controller('listSaboresController', ['$scope', '$http', '$routeParams', '$location', 'saborService', 'utilsService', function($scope, $http, $routeParams, $location, saborService, utilsService){

        $scope.editSabor = function(sabor){
                $location.url('/editSabor/' + $scope.codEstabelecimento + '/' + sabor.codSabor);
        }

        $scope.newSabor = function(){
                $location.url('/editSabor/' + $scope.codEstabelecimento);
        }
